  ...
  return (
    <form className="flex flex-wrap gap-3 mb-6" onSubmit={handleSubmit}>
      <div className="flex-1 min-w-[200px]">
        <input
          type="text"
          className="w-full rounded-lg px-4 py-3 text-base font-[-apple-system] bg-[#F2F2F7] dark:bg-[#1C1C1E] text-black dark:text-white placeholder-[#8E8E93] dark:placeholder-[#48484A] focus:outline-none focus:ring-2 focus:ring-[#007AFF] dark:focus:ring-[#0A84FF] transition-all"
          value={text}
